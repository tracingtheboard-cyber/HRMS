    ...
    <div class="col-md-8 offset-md-2">
        <div class="card">
            <div class="card-header">
                <h4><i class="bi bi-plus-circle"></i> 新建薪资记录</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('payrolls.store') }}" method="POST" id="payrollForm">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('unutilised_pay_leave') is-invalid @enderror" 
                                   ...
                                   value="{{ old('unutilised_pay_leave', 0) }}" 
                                   min="0">
                    ...
                    <div class="alert alert-info mb-4">
                        <strong>总收入 (Total Earnings)：</strong> <span id="totalEarnings">¥0.00</span>
                    </div>
                    ...
                    <div class="alert alert-warning mb-4">
                        <strong>总扣除 (Total Deduction)：</strong> <span id="totalDeduction">¥0.00</span>
                        <br>
                        <strong>净工资 (Net Pay)：</strong> <span id="netPay">¥0.00</span>
                    </div>
                    ...
                    <div class="alert alert-success mb-4">
                        <strong>其他扣除后的净工资 (Net Pay after other deduction)：</strong> <span id="netPayAfterOther">¥0.00</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle"></i> 创建记录
                        </button>
                    </div>
                </form>
            </div>
